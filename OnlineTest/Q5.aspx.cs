    ...
    public partial class Q5 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                cmd.CommandText = "select * from Questions where QuestionNo=5";
                cmd.Connection = con;
        ...
        protected void btnsub_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    con.Open();
                    SqlCommand cmd = new SqlCommand();
                    cmd.CommandText = "select * from Answer where Email='" + lblemail.Text + "' and QuestionNo=5";
                    cmd.Connection = con;
                    SqlDataReader dr = cmd.ExecuteReader();
                    if (dr.Read())
                        z = 1;
                con.Close();
                    ...
                    if (z == 1)
                    {
                        ...
                        cmdd.CommandText = "update Answer set Answer='" + lblans.Text + "' where Email='" + lblemail.Text + "' and QuestionNo=5";
                    ...
                    else
                    {
                        ...
                        conn.Open();
                        SqlCommand cmdd = new SqlCommand();
                        cmdd.CommandText = "insert into Answer values('" + lblemail.Text + "',5,'" + lblans.Text + "') ";
                        cmdd.Connection = conn;
                        int i = cmdd.ExecuteNonQuery();
                    if (i > 0)
                    {
    ...
    // btn5.BackColor = System.Drawing.Color.Green;
        ...
        protected void btnskip_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                conn.Open();
                SqlCommand cmdd = new SqlCommand();
                cmdd.CommandText = "select * from Answer where Email='" + lblemail.Text + "' and QuestionNo=5";
                cmdd.Connection = conn;
                ...
                conn.Close();
                    ...
                    con.Open();
                    SqlCommand cmd = new SqlCommand();
                    cmd.CommandText = "update Answer set Answer='null' where Email='" + lblemail.Text + "' and QuestionNo=5";
                    cmd.Connection = con;
                ...
                else
                {
                    ...
                    con.Open();
                    SqlCommand cmd = new SqlCommand();
                    cmd.CommandText = "insert into Answer values('" + lblemail.Text + "',5,'null') ";
                    cmd.Connection = con;
                    int i = cmd.ExecuteNonQuery();
                if (i > 0)
                {
