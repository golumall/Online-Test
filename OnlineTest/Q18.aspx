<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Q18.aspx.cs" Inherits="OnlineTest.Q18" %>
       ...
       <tr> <td><center class="auto-style1" ><strong>Question</strong></td><td><center class="auto-style3"><strong>Questions</strong></center></td></tr>
         ...
         <tr>  <td><div id="d1">
          <table style="text-align:left;padding:20px" class="auto-style5">
              <tr><td colspan="3" class="auto-style6">Q18:-<asp:Label ID="lbl1" runat="server"></asp:Label></td></tr>
            ...
            <center> <table class="auto-style19">
      <tr>
          <td><center><asp:Button ID="btnsub" runat="server" Text="Submit&amp;Finish" Height="33px" Width="110px" OnClick="btnsub_Click" /></center></td>
          <td><center><asp:Button ID="btnskip" runat="server" Text="Skip&Finish" Height="33px" Width="110px" OnClick="btnskip_Click" /></center></td>
        ...
        <div id="d2" class="auto-style2">
            <table class="auto-style8">
                ...
                <tr>
                    ...
                    <td><center><asp:Button ID="btn5" runat="server" Text="5"  Font-Bold="true" style="width:30px;height:30px;" OnClick="btn5_Click"></asp:Button></center></td>
                ...
                <tr>
                    ...
                    <td><center><asp:Button ID="btn17" runat="server" Text="17"  Font-Bold="true" style="width:30px;height:30px;"></asp:Button></center></td>
                    <td><center><asp:Button ID="btn18" runat="server" Text="18"  Font-Bold="true" style="width:30px;height:30px;"></asp:Button></center></td>
                </tr>
                 </table>
        </div></td></tr></table>
