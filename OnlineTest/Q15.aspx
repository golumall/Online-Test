<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Q15.aspx.cs" Inherits="OnlineTest.Q15" %>
       ...
       <tr> <td><center class="auto-style1" ><strong>Question</strong></td><td><center class="auto-style3"><strong>Questions</strong></center></td></tr>
         ...
         <tr>  <td><div id="d1">
          <table style="text-align:left;padding:20px" class="auto-style5">
              <tr><td colspan="3" class="auto-style6">Q15:-<asp:Label ID="lbl1" runat="server"></asp:Label></td></tr>
