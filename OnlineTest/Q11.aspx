<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Q11.aspx.cs" Inherits="OnlineTest.Q11" %>
...
<body>
    ...
    <asp:Timer ID="Timer1" runat="server" Interval="1000" OnTick="Timer1_Tick" Enabled="true">
                       ...
                       <td><center><strong>Remaining Time:&nbsp;&nbsp;&nbsp;&nbsp; <asp:Label ID="lbltime" runat="server" Text=""></asp:Label></strong></center></td>
       ...
       <tr> <td><center class="auto-style1" ><strong>Question</strong></td><td><center class="auto-style3"><strong>Questions</strong></center></td></tr>
         ...
         <tr>  <td><div id="d1">
          <table style="text-align:left;padding:20px" class="auto-style5">
              <tr><td colspan="3" class="auto-style6">Q11:-<asp:Label ID="lbl1" runat="server"></asp:Label></td></tr>
