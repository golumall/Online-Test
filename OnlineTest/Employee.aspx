<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Employee.aspx.cs" Inherits="OnlineTest.Employee" %>
...
<body>
    ...
    <div id="d2">
            ...
            <center>
                <table style="background-color:navy;color:white;border-radius:20px;" class="auto-style3">
                    <tr><td colspan="2" class="auto-style2" style="border-bottom:solid 1px white"><strong><center>Employee Login</center></strong></td></tr>
   ...
   <tr><td colspan="2"><center><asp:Button ID="btnsub" runat="server" Text="Submit" OnClick="btnsub_Click" /></center></td></tr>
                   
                </table>
                 <br /><br />
                <table style="width:100%;height:50px;">
            <tr><td class="auto-style11"><a href="Login.aspx" class="x"><center>User Login</center></a></td><td><a href="Admin.aspx" class="x"><center>Admin Login</center></a></td></tr>
