<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Q6.aspx.cs" Inherits="OnlineTest.Q6" %>
...
<body>
    ...
    <asp:Timer ID="Timer1" runat="server" Interval="1000" OnTick="Timer1_Tick" Enabled="true">
       ...
       <tr> <td><center class="auto-style1" ><strong>Question</strong></td><td><center class="auto-style3"><strong>Questions</strong></center></td></tr>
         ...
         <tr>  <td><div id="d1">
          <table style="text-align:left;padding:20px" class="auto-style5">
              <tr><td colspan="3" class="auto-style6">Q6:-<asp:Label ID="lbl1" runat="server"></asp:Label></td></tr>
       ...
       <tr>
           <td><center><asp:Button ID="btnsub" runat="server" Text="Submit" Height="33px" Width="62px" OnClick="btnsub_Click"></asp:Button></center></td>
        ...
        <div id="d2" class="auto-style2">
            <table class="auto-style8">
                ...
                <tr>
                    ...
                    <td><center><asp:Button ID="btn6" runat="server" Text="6" Font-Bold="true" style="width:30px;height:30px;"></asp:Button></center></td>
                </tr>
