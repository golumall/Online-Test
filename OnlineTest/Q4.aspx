<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Q4.aspx.cs" Inherits="OnlineTest.Q4" %>
       ...
       <tr> <td><center class="auto-style1" ><strong>Question</strong></td><td><center class="auto-style3"><strong>Questions</strong></center></td></tr>
         ...
         <tr>  <td><div id="d1">
          <table style="text-align:left;padding:20px" class="auto-style5">
              <tr><td colspan="3" class="auto-style6">Q4:-<asp:Label ID="lbl1" runat="server"></asp:Label></td></tr>
       ...
       <tr>
        ...
        <div id="d2" class="auto-style2">
            ...
            <tr>
                ...
                <td><center><asp:Button ID="btn4" runat="server" Text="4" Font-Bold="true" style="width:30px;height:30px;"></asp:Button></center></td>
